...
python -m earlyexitnet.cli --dataset cifar10 -m resnet8_2ee -mp ./trained_models/resnet8_2ee_230721_jnt-frm-scrtch.pth -t1 0.75 -entr 0.01 -gpu 0 -nw 8 -bste 500 -cf 0 1 2 3 4 -sr True
